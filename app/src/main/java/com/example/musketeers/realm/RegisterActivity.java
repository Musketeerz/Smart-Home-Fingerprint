...
//            databaseReference = FirebaseDatabase.getInstance().getReference(KEY).child("SENSOR STATUS");
//            databaseReference.child("HUMAN PRESENCE").setValue("Human Presence_false");
//            databaseReference.child("DARKNESS").setValue("Darkness_false");

           // int LOW=0;

//            databaseReference = FirebaseDatabase.getInstance().getReference(KEY).child("NODE MCU STATUS");
//            databaseReference.child("HEATER").setValue(LOW);
//            databaseReference.child("IRON BOX").setValue(LOW);
//            databaseReference.child("OUTSIDE LIGHT").setValue(LOW);
//            databaseReference.child("BEDROOM LIGHT").setValue(LOW);
//            databaseReference.child("WATER MOTOR").setValue(LOW);
//            databaseReference.child("BEDROOM FAN").setValue(LOW);
//            databaseReference.child("WASHING MACHINE").setValue(LOW);
