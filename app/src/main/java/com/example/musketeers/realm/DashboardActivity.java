            ...
            if (cmd.contains("eco")) {
                ...
                if (cmd.contains("on")) {
                    if (a_switch.get(i)) {
                        ...
                        databaseReference = FirebaseDatabase.getInstance().getReference(passcode_pass).child("DEVICE STATUS");
                        databaseReference.child(name_voice_.toUpperCase()).setValue(a_name.get(i) + "_true_10000");
                    }
                } else if (cmd.contains("off")) {
                    if (!a_switch.get(i)) {
                        got = 1;
                        ...
                        databaseReference = FirebaseDatabase.getInstance().getReference(passcode_pass).child("DEVICE STATUS");
                        databaseReference.child(name_voice_.toUpperCase()).setValue(a_name.get(i) + "_false_10000");
                    }
                } else {
